...
const Works = () => {
    return (
        <section className="py-20 mt-35 mb-24 bg-white text-center" id="works">
            <div className="container mx-auto px-4">
                <span className={`${poppin.className} bg-purple-100 text-purple-600 py-1 px-3 rounded-full text-sm font-semibold`}>
                    WORK PROCESS
                </span>
